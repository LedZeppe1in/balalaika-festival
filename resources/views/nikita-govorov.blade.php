...
<head>
    ...
    <title>Никита Говоров</title>
    <link rel=canonical href=https://balalaika21veka.ru/participants/nikita-govorov/ >
    <meta property="og:locale" content="ru_RU">
    <meta property="og:type" content="article">
    <meta property="og:title" content="Никита Говоров">
    <meta property="og:description" content="Никита Говоров - победитель 50-ти Всероссийских и Международных конкурсов.">
    <meta property="og:url" content="https://balalaika21veka.ru/participants/nikita-govorov/">
...
<body class="artist-template artist-template-templates artist-template-tabula-rasa artist-template-templatestabula-rasa-php single single-artist postid-264 wp-custom-logo wp-embed-responsive has-post-thumbnail hide-avatars site-footer-has-background">
                                ...
                                <div class="wp-block-columns alignwide is-layout-flex wp-container-core-columns-layout-2 wp-block-columns-is-layout-flex">
                                    ...
                                    <div class="wp-block-column is-layout-flow wp-block-column-is-layout-flow" style=flex-basis:33.62%>
                                        <figure class="wp-block-image size-full">
                                            <img fetchpriority=high decoding=async src="data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%20422%20606'%3E%3C/svg%3E" data-src="{{URL::asset('/images/Nikita_Govorov.jpg')}}" alt="Никита Говоров" class="wp-image-3183 lazy">
                                        </figure>
                                    </div>
