...
<head>
    ...
    <title>Страница не найдена - Фестиваль «Балалайка XXI века» 2024</title>
    <meta property="og:locale" content="ru_RU">
    <meta property="og:title" content="Страница не найдена - Фестиваль «Балалайка XXI века» 2024">
...
<body class="error404 wp-custom-logo wp-embed-responsive hide-avatars site-footer-has-background">
    <div id=site-wrapper class=uk-offcanvas-content>
                        ...
                        <div class="uk-width-expand uk-flex uk-flex-center">
                            <div class="uk-navbar-item uk-visible@m">
                                <ul id=menu-navbar class=uk-navbar-nav>
                                    <li id=menu-item-1 class="menu-item menu-item-type-post_type_archive menu-item-object-artist menu-item-1">
        ...
        <main id=site-content role=main>
            <div class="uk-section uk-section-large uk-container uk-container-small error-404">
                <h1 class="entry-title">Страница не найдена</h1>
                <div class=uk-text-meta><p>Страница, которую вы искали не найдена. Возможно она была переименована или удалена.</p></div>
            </div>
        </main>
