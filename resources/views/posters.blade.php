...
<head>
    ...
    <title>Фестиваль «Балалайка XXI века» 2024 - Программа</title>
    <meta name="description" content="Официальный сайт фестиваля «Балалайка XXI века» 2024. Подробнее о программе.">
    <link rel=canonical href=https://balalaika21veka.ru/posters/>
    <meta property="og:locale" content="ru_RU">
    <meta property="og:type" content="article">
    <meta property="og:title" content="Фестиваль «Балалайка XXI века» 2024 - Программа">
    <meta property="og:description" content="Официальный сайт фестиваля «Балалайка XXI века» 2024. Подробнее о программе.">
    <meta property="og:url" content="https://balalaika21veka.ru/posters/">
    ...
    <style id=buy-button-style-inline-css>.wp-block-buy-button{border:unset;border-radius:100px;cursor:pointer;font-size:clamp(1.5rem,1.375rem + .625vw,1.875rem);padding:1.375rem 2.813rem;transform:translateY(0);transition:all .25s ease-in-out}.wp-block-buy-button:focus,.wp-block-buy-button:hover{transform:translateY(-6px)}</style>
...
<body class="page-template page-template-templates page-template-tabula-rasa page-template-templatestabula-rasa-php page page-id-205 page-child parent-pageid-44 wp-custom-logo wp-embed-responsive missing-post-thumbnail hide-avatars site-footer-has-background">
                        ...
                        <div class="uk-width-expand uk-flex uk-flex-center">
                            <div class="uk-navbar-item uk-visible@m">
                                <ul id=menu-navbar class=uk-navbar-nav>
                                    ...
                                    <li id=menu-item-3 class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-2 current_page_item menu-item-3">
        ...
        <main id=site-content class=uk-margin-remove role=main>
            <section class="section-margin uk-container uk-container-large">
                <div class="artists-header uk-padding">
                    <h1 class="tm-heading-large uk-text-secondary" style="">Программа</h1>
                </div>
                <div class="entry-content-wrapper uk-padding-remove">
                    <div class=entry-content>
                        <div class="wp-block-columns alignwide is-layout-flex wp-container-core-columns-layout-1 wp-block-columns-is-layout-flex">
                            <div class="wp-block-column uk-border-rounded has-text-color has-background has-link-color wp-elements-f51c6fd72ba56e36a9a7c1f2ea555130 is-layout-flow wp-block-column-is-layout-flow" style=color:#000000;background-color:#f9f4ec;padding-top:2em;padding-right:2em;padding-bottom:2em;padding-left:2em>
                                <figure class="wp-block-image size-large">
                                    <img decoding=async width=1024 height=576 src="data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%201024%20576'%3E%3C/svg%3E" data-src="{{URL::asset('/images/opening-poster.png')}}" alt class="wp-image-3402 lazy" data-sizes="(max-width: 1024px) 100vw, 1024px">
                                </figure>
