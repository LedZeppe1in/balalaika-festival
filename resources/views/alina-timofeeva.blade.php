...
<head>
    ...
    <title>Алина Тимофеева</title>
    <link rel=canonical href=https://balalaika21veka.ru/participants/alina-timofeeva/ >
    <meta property="og:locale" content="ru_RU">
    <meta property="og:type" content="article">
    <meta property="og:title" content="Алина Тимофеева">
    <meta property="og:description" content="Тимофеева Алина Ильдаровна начала обучение в классе фортепиано в ДМШ № 1 им. П. И. Чайковского.">
    <meta property="og:url" content="https://balalaika21veka.ru/participants/alina-timofeeva/">
...
<body class="artist-template artist-template-templates artist-template-tabula-rasa artist-template-templatestabula-rasa-php single single-artist postid-3287 wp-custom-logo wp-embed-responsive has-post-thumbnail hide-avatars site-footer-has-background">
                            ...
                            <div class=wp-block-group__inner-container>
                                <div class="wp-block-columns alignwide is-layout-flex wp-container-core-columns-layout-1 wp-block-columns-is-layout-flex">
                                    <div class="wp-block-column is-layout-flow wp-block-column-is-layout-flow">
                                        ...
                                        <p class="has-text-color" style=font-size:5vw;line-height:1.1><strong>Алина Тимофеева</strong></p>
                                ...
                                <div class="wp-block-columns alignwide is-layout-flex wp-container-core-columns-layout-2 wp-block-columns-is-layout-flex">
                                    ...
                                    <div class="wp-block-column is-layout-flow wp-block-column-is-layout-flow" style=flex-basis:33.62%>
                                        <figure class="wp-block-image size-full">
                                            <img fetchpriority=high decoding=async src="data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%201600%201066'%3E%3C/svg%3E" data-src="{{URL::asset('/images/Alina_Timofeeva.jpg')}}" alt="Алина Тимофеева" class="wp-image-3290 lazy">
                                        </figure>
                                    </div>
                                </div>
